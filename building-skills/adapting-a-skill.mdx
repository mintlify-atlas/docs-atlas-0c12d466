...
<CardGroup cols={2}>
  <Card title="Rewriting into a framework" icon="triangle-exclamation">
  ...
  <Card title="Reorganizing folders" icon="triangle-exclamation">
  ...
  <Card title="Marketplace assumptions" icon="triangle-exclamation">
