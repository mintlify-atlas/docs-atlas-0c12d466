...
<Steps>
  ...
  <Step title="Mount the core load-sequence files">
    Each file declared in `load_sequence` — `ENTRY.md`, `README.md`, `SEMANTICS.md`, and `OPERATIONAL_RULES.md` — is read and validated as a required UTF-8 text file. All four are required; a missing or unreadable file in `load_sequence` causes a hard fail.
  </Step>
...
<CardGroup cols={2}>
  <Card title="ENTRY.md" icon="door-open" href="/using-skills/session-lifecycle">
  ...
  <Card title="README.md" icon="book-open" href="/using-skills/session-lifecycle">
  ...
  <Card title="SEMANTICS.md" icon="brain" href="/using-skills/session-lifecycle">
  ...
  <Card title="OPERATIONAL_RULES.md" icon="list-check" href="/reference/commands">
