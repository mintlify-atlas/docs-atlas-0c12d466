...
<CardGroup cols={3}>
  <Card title="PASS" icon="circle-check" href="#compatibility-ratings">
  ...
  <Card title="PASS_WITH_WARNINGS" icon="circle-exclamation" href="#compatibility-ratings">
  ...
  <Card title="BLOCKED" icon="ban" href="#compatibility-ratings">
...
- **Required `pip install` or network install** — tool files that depend on packages unavailable in the GPT Python environment.
- **Required hook, daemon, watcher, external CLI, or persistent service** — the skill depends on runtime mechanisms the system does not provide.
